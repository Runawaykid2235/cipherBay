    ...
    return (
        <div>
            <div style={{
                ...
                <h1 style={{ marginLeft: '10px' }}>AugmentPro Desktop App</h1>
            </div>

            <div>
                <p>This project is a full-stack application built with React and Rust. It utilizes the Tauri library to package a desktop executable where users can create datasets from PNG images and corresponding masks. This is useful for generating labeled image data for machine learning and computer vision tasks.</p>
                <p>The backend is developed in Rust, while the frontend is powered by React and Vite. The final executable is under 10 MB in size, making it lightweight and efficient for distribution. Currently, it is available for Windows, but please note that the executable is unsigned, so it may trigger antivirus warnings upon installation.</p>
                <p>You can check out the project on GitHub:</p>
                <a href="https://github.com/Runawaykid2235/Projectgenisis" target="_blank" rel="noopener noreferrer">
                    AugmentPro GitHub Repository
                </a>
            </div>
        </div>
    );
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <span><u>R</u>ust Projects</span>
                    </div>
                    <button onClick={() => setSelectedProject('Project1')} style={buttonStyle}>AugmentPro</button>
...
export default AllRustProjects;
